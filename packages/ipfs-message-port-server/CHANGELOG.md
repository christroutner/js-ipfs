...
## [0.8.1](https://github.com/christroutner/js-ipfs/compare/@chris.troutner/ipfs-message-port-server@0.8.0...@chris.troutner/ipfs-message-port-server@0.8.1) (2021-09-02)

**Note:** Version bump only for package @chris.troutner/ipfs-message-port-server
